    ...
    <q-card class="chara-card q-mx-auto">
      ...
      <q-card-section>
        <q-btn
          ...
          :to="'/character/' + c.name"
        >
          <q-avatar><img style="width: 100%" :src="c.icon" /></q-avatar>
        </q-btn>
        <q-btn round fab-mini padding="xs" to="/character/all">
          <q-avatar>All</q-avatar>
        </q-btn>
      </q-card-section>
      <q-card-section>
        <div v-for="c in chara" :key="c.name">
          <q-card flat v-if="name == c.name || name == 'all'">
            <q-card-section>
              <div class="text-h6" style="margin: 10px auto 10px auto">{{ c.namae }}</div>
              CV:<label v-html="c.cv"></label>
            </q-card-section>
            <q-card-section class="text-subtitle2" style="white-space: pre-wrap">
              {{ c.text }}
            </q-card-section>
            <q-card-section>
              <q-expansion-item
              ...
              >
                <q-card class="text-left">
                  ...
                  <q-card-section>
                    ...
                    <div
                      v-for="mainProd in getProductsBanner(c.cvArray, 'mainAct')"
                      :key="mainProd"
                    >
...
const chara = [
  {
    ...
    cv: '雁庵うずめ',
    cvArray: ['雁庵うずめ'],
    icon: '/img/character/seri-205.jpg',
  ...
  },
  {
    name: 'suzusiro',
    namae: 'すずしろ/しろさん',
    icon: '/img/character/suzusiro-241.jpg',
  ...
  },
  {
    ...
    cvArray: ['藤堂れんげ'],
    icon: '/img/character/suzuna-177.jpg',
  ...
  },
  {
    name: 'hakobera',
    namae: 'はこべら/はこさん',
    icon: '/img/character/hako-256.jpg',
  ...
  },
  {
    ...
    cvArray: ['真宮ひいろ'],
    icon: '/img/character/ine-177.jpg',
  ...
  },
  {
    ...
    cvArray: ['愛枝今日子', 'ルナ'],
    icon: '/img/character/tabirako-185.jpg',
  ...
  },
  {
    ...
    cvArray: ['箱河ノア'],
    icon: '/img/character/inoko-251.jpg',
  ...
  },
  {
    name: 'natuna',
    namae: 'なつな/なっちゃん',
    icon: '/img/character/natuna-250.jpg',
  ...
  setup() {
    ...
    const getProductsBanner = computed(() => {
      return function (cvArray: Array<string>, prodType = 'mainAct') {
        const charaProdcts = db.products.filter((v) =>
          cvArray.some((cv) =>
            prodType == 'mainAct' ? v.mainAct.includes(cv) : v.subAct.includes(cv),
          ),
        );
